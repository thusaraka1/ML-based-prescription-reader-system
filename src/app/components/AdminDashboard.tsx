...
export function AdminDashboard({ user, dashboard, onLogout, onRefresh }: AdminDashboardProps) {
  ...
  const handleAddCaretaker = () => {
    ...
    setCaretakerForm({ name: '', email: '', phone: '', specialization: '' });
    onRefresh();
  };
  ...
  const handleApproveLeave = (request: any) => {
  ...
  const handleRejectLeave = (request: any) => {
        ...
        <div className="fixed inset-0 bg-black/50 flex items-end sm:items-center justify-center z-50">
          <div className="bg-white rounded-t-2xl sm:rounded-2xl w-full sm:max-w-md">
            <div className="bg-green-500 text-white px-4 py-3 flex items-center justify-between rounded-t-2xl">
              ...
              <button onClick={() => setShowAddCaretaker(false)} className="p-1">
                <X className="w-5 h-5" />
              </button>
            </div>
            <div className="p-4 space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2 pt-2">
                ...
                <button
                  ...
                  disabled={!caretakerForm.name || !caretakerForm.email}
                  className="py-2.5 bg-green-500 text-white rounded-lg font-medium text-sm disabled:opacity-50"
                >
                  Add Caretaker
                </button>
              </div>
